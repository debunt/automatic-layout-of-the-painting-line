...
IFontDisp = Font
__all__ = [ 'Gray', 'LoadPictureConstants', 'OLE_XSIZE_CONTAINER',
           'OLE_OPTEXCLUSIVE', 'OLE_HANDLE', 'FontEvents',
           'FONTITALIC', 'IPictureDisp', 'OLE_YPOS_HIMETRIC',
           'FONTNAME', 'Color', 'IPicture', 'FONTBOLD',
           'FONTUNDERSCORE', 'OLE_COLOR', 'IFontDisp', 'Font',
           'IFont', 'FONTSTRIKETHROUGH', 'FONTSIZE',
           'IFontEventsDisp', 'OLE_TRISTATE', 'Picture', 'VgaColor',
           'OLE_XPOS_PIXELS', 'OLE_XPOS_HIMETRIC', 'StdFont',
           'OLE_YPOS_PIXELS', 'Monochrome', 'OLE_YSIZE_PIXELS',
           'OLE_YSIZE_CONTAINER', 'StdPicture', 'OLE_CANCELBOOL',
           'OLE_ENABLEDEFAULTBOOL', 'Unchecked', 'Default', 'Checked',
