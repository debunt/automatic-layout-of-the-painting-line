...
class Autocad(object):
    ...
    def size_scale(self, dimscale):
        command_str = f"DIMSCALE {dimscale} " # установка аннотативного масштаба
        self.doc.SendCommand(command_str)


    def linear_size(self, p1x, p1y, p2x, p2y, indent):

        command_str = f'_dimlinear {p1x},{p1y} {p2x},{p2y} {p1x},{-indent + p1y} '
